...
import com.kenkorcak.sstimerapp.databinding.ActivityOneToOneRatioBinding
import java.util.Locale


class OneToOneRatio : AppCompatActivity() {

    private lateinit var binding: ActivityOneToOneRatioBinding
    ...
    private val swingTimerInterval = 40000L
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityOneToOneRatioBinding.inflate(layoutInflater)
