...
import com.kenkorcak.sstimerapp.databinding.ActivityOneToTwoRatioBinding
import java.util.Locale

class OneToTwoRatio : AppCompatActivity() {

    private lateinit var binding: ActivityOneToTwoRatioBinding
    ...
    private val tguTimerInterval = 90000L

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        this.requestedOrientation = ActivityInfo.SCREEN_ORIENTATION_PORTRAIT
        binding = ActivityOneToTwoRatioBinding.inflate(layoutInflater)
